...
class RoomAdapter (private val data: Array<String>, private val typeData:Array<Int>) : RecyclerView.Adapter<RoomAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        init {
            TitleText = itemView?.findViewById<TextView>(R.id.room_device_text)
            Image = itemView?.findViewById(R.id.room_device_img);
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.itemroom, parent, false)
